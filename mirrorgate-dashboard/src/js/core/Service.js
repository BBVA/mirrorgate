...
var Service = (function() {
  ...
  var self = {
    types: {
      ...
      builds_stats: new ServiceType(Timer.eventually, 'builds/rate','BuildStatsType'),
      bugs: new ServiceType(Timer.eventually, 'bugs'),
      stories: new ServiceType(Timer.rarely, 'stories', 'IssueType'),
      apps: new ServiceType(Timer.rarely, 'applications', 'ReviewType'),
      dashboard: new ServiceType(Timer.never, 'details', 'DashboardType'),
      dashboards: new ServiceType(Timer.never),
      programIncrement: new ServiceType(Timer.eventually, 'program-increment', 'IssueType'),
